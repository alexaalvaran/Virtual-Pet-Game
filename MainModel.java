...
public class MainModel {
    ...
    public void loadExistingGame() {
        if (db.findExistingPlayer(this.player.getPlayerName())) {
            ...
            stats.setHungerValue(db.loadHunger(player.getPlayerName()));
            stats.setThirstValue(db.loadThirst(player.getPlayerName()));
            stats.setEnergyValue(db.loadEnergy(player.getPlayerName()));
            stats.setHygieneValue(db.loadHygiene(player.getPlayerName()));
            stats.setHappinessValue(db.loadHappiness(player.getPlayerName()));
            stats.setFriendshipValue(db.loadFriendship(player.getPlayerName()));
        } else {
